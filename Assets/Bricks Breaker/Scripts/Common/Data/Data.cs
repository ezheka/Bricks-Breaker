...
public class Data
{
    ...
    public static string scene_home = "2_Home_My";
    public static string scene_play = "3_Play";
    public static string scene_result = "4_Result";

    //Product Web Url
    public const string url_facebook = "https://www.facebook.com/layerlab/";



#if UNITY_ANDROID
    public const string url_app = "https://play.google.com/store/apps/details?id=com.homep.kickthatbrick";
...
#if UNITY_ANDROID
    public const string url_othergame = "https://play.google.com/store/apps/details?id=com.homep.kickthatbrick";
#elif UNITY_IOS || UNITY_EDITOR
    public const string url_othergame = "https://play.google.com/store/apps/details?id=com.homep.kickthatbrick";
#endif
